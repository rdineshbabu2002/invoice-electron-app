...
const BillTemplate = () => {
  ...
  const sendMail = async (e) => {
    ...
    console.log(parseInt(tableTotalValues.totalAmount));
      ...
      line_items: [
        {
          price_data: {
            ...
            unit_amount: parseInt(tableTotalValues.totalAmount * 100),
          },
          quantity: 1,
        },
      ],
    ...
    let values = {
      invoiceNo: formDetails.invoice,
      name: formDetails.name,
      to: formDetails.name,
      vehicleNo: formDetails.vehicleNo,
      amountInWords: tableTotalValues.amountInWords,
      link: paymentLink,
      email,
      totalAmount: tableTotalValues.totalAmount,
    };
  ...
  return (
    <div>
      ...
      <Modal isModalOpen={modelOpen} setIsModalOpen={setModelOpen}>
        <div className="bill-modal-container">
          <p>Enter the Email :</p>
          <div className="model-bill-container">
            <input
              value={email}
              onChange={(e) => {
              ...
              className="forminput"
            />
            <div className="model-bill-btn-container">
              <button onClick={sendMail} className="bill-button send-mail">
                Send Mail
              </button>
              <button
